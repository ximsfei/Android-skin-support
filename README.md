...
[![skin-support-v2.1.0](https://img.shields.io/badge/skin--support-v2.1.0-green.svg)](http://jcenter.bintray.com/skin/support/skin-support/2.1.0/)
...
```xml
compile 'skin.support:skin-support:2.1.0'          // skin-support 基础控件支持
