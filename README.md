...
[![skin-support-v2.1.2](https://img.shields.io/badge/skin--support-v2.1.2-green.svg)](http://jcenter.bintray.com/skin/support/skin-support/2.1.2/)
...
```xml
compile 'skin.support:skin-support:2.1.2'          // skin-support 基础控件支持
