...
[![skin-support-v2.1.3](https://img.shields.io/badge/skin--support-v2.1.3-green.svg)](http://jcenter.bintray.com/skin/support/skin-support/2.1.3/)
...
```xml
compile 'skin.support:skin-support:2.1.3'          // skin-support 基础控件支持
